/*------------------------------------------------------------------------------------------------------/
| Program : AddressLookUpBeforev3.0.js
| Event   : AddressLookUpBefore
| Source  : UniversalMasterScriptV3.0.js
|
...
| Action# : N/A
|
| Notes   : Created 06/01/2016, ghess
|
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
var eventType = "Before";				//Assume after event
if (triggerEvent != ""){
...
// Added to Universal script
CapIdModel = aa.env.getValue("CapIdModel");
...
// added so hierarchical actions work
