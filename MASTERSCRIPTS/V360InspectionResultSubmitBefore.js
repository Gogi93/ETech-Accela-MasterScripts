...
var inspResultCommentIdArr = aa.env.getValue("InspectionResultCommentIdArray");
var StaffFirstNameArr = aa.env.getValue("StaffFirstNameArray");
var StaffLastNameArr = aa.env.getValue("StaffLastNameArray");
var StaffMiddleNameArr = aa.env.getValue("StaffMiddleNameArray"); 
var TimeAccountingArr = aa.env.getValue("TimeAccountingArray");
var TotalTimeArr = aa.env.getValue("TimeTotalArray");
...
for (thisElement in s_id1) {
	...
	r.inspTotalTime = TotalTimeArr[thisElement];
...
for (thisResult in resultObjArray) {
	...
	inspTotalTime = curResult.inspTotalTime;
...
function resultObj() {
	...
	this.inspTotalTime = null;
	this.inspResultCommentIdA = null;
	this.StaffFirstName = null;
	this.StaffLastName = null;
	this.StaffMiddleName = null;
	this.TimeAccounting = null;
}
