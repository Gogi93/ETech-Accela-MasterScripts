/**
 * @file - EMSE_MA_INT_C_LICENSE_PSI:
...
LicenseData.prototype.createLicense = function(lcapId, queryResult) {
    ...
    //Fix for PROD Defect 7447 : interface is using system date to set issue date for license. Should be using the issue date provided in the interface
